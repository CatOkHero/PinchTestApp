...
namespace TestApp.Droid
{
    public class TouchEffect : PlatformEffect
	{
        ...
        TestApp.ViewModel.TouchEffect pclTouchEffect;
        bool capture;
		...
		protected override void OnAttached()
        {
            ...
            TestApp.ViewModel.TouchEffect touchEffect =
                (TestApp.ViewModel.TouchEffect)Element.Effects.
                    FirstOrDefault(e => e is TestApp.ViewModel.TouchEffect);
	        try
	        {
