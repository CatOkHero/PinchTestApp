...
using Xamarin.Forms;
using Android.Views;
using TestApp.Droid.Listeners;
using TestApp.Droid.Renderers;

[assembly: ExportRenderer (typeof(TestApp.Controls.GridWithGesture), typeof(GridWithGestureRendedrer))]

namespace TestApp.Droid.Renderers
{
	public class GridWithGestureRendedrer : ViewRenderer<TestApp.Controls.GridWithGesture, Android.Views.View>, ScaleGestureDetector.IOnScaleGestureListener
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<TestApp.Controls.GridWithGesture> e)
		{
